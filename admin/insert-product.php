...
<div class="control-group">
<label class="control-label" for="basicinput">Nombre de la Compañia</label>
<div class="controls">
...
<div class="controls">
<input type="text"    name="productprice"  placeholder="Ingrese el precio del producto" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="productShippingcharge"  placeholder="Ingrese el costo de envío del producto" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<select   name="disponibilidad de producto"  id="productAvailability" class="span8 tip" required>
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen del producto1</label>
<div class="controls">
