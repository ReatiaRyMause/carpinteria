...
<head>
	...
	<title>Actualizar imagen del producto</title>
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen del producto actual 2</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Nuevo producto Imagen 2</label>
<div class="controls">
