...
header('location:.php');
	...
	if(isset($_POST['update']))
	{
		...
		$query=mysqli_query($con,"actualizar usuarios establecer dirección de facturación='$baddress',billingState='$bstate',billingCity='$bcity',billingPincode='$bpincode' where id='".$_SESSION['id']."'");
		if($query)
		{
...
// code for Shipping address updation
	if(isset($_POST['shipupdate']))
	{
		...
		$query=mysqli_query($con,"actualizar usuarios establecer dirección de envío='$saddress',shippingState='$sstate',shippingCity='$scity',shippingPincode='$spincode' where id='".$_SESSION['id']."'");
		if($query)
		{
