...
<div class="body-content outer-top-xs" id="top-banner-and-menu">
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-3 sidebar"><?php include('includes/side-menu.php');?>
		</div>
...
?>
	...
	<div class="product">		
		...
		<?php if($row['productAvailability']=='In Stock'){?>
					<div class="action"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-primary">añadir a la cesta</a></div>
				<?php } else {?>
