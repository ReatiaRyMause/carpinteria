...
if(strlen($_SESSION['login'])==0)
    {   
		header('location:order-history.php?totalprice=' . $totalprice);
					...
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								...
								<input type="submit" name="submit" value="Actualizar carrito de compra" class="btn btn-upper btn-primary pull-right outer-right-xs">
							</span>
						</div>
					</td>
				</tr>
...
<div class="col-md-4 col-sm-12 cart-shopping-total">
			...
			<tr>
				<th>
					...
					<div class="cart-grand-total">
						Total MXN<span class="inner-left-md"><?php echo $_SESSION['tp']="$totalprice". ".00"; ?></span>
					</div>
				</th>
			</tr>
		</thead>
		<tbody>
				<tr>
					<td>
						...
						<button type="submit" name="ordersubmit" class="btn btn-primary">PAGAR</button>
	...
	<?php } else {
echo "Su carrito de compra está vacío.";
		}?>
</div>			</div>
		</div> 
		</form>
